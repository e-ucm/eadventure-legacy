...
public class ImageElementNode extends ImageElement {
	...
	public ImageElementNode(NodeDataControl nodeDataControl) {
		...
		if (playerImage != null) {
			image = new BufferedImage((int) (playerImage.getWidth(null)*nodeDataControl.getScale()),
										(int) (playerImage.getHeight(null)*nodeDataControl.getScale()) + 10, BufferedImage.TYPE_4BYTE_ABGR);
		} else {
	...
	private void fillImage() {
		...
		if (playerImage != null) {
			int width = (int) (playerImage.getWidth(null) * nodeDataControl.getScale());
			int height = (int) (playerImage.getHeight(null) * nodeDataControl.getScale());
