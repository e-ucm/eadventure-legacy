...
public class ImageElementInfluenceArea extends ImageElement {
	...
	public ImageElementInfluenceArea(
		...
		if (influenceAreaDataControl.hasInfluenceArea())
			...
			int height = (int) (reference.getImage().getHeight(null)
					* reference.getScale() + 40);
	...
	public void changePosition(int x, int y) {
		if (!influenceAreaDataControl.hasInfluenceArea()) {
			int width = (int) (imageElementReference.getImage().getWidth(null)
					* imageElementReference.getScale() + 40);
			int height = (int) (imageElementReference.getImage()
					.getHeight(null)
					* imageElementReference.getScale() + 40);
	...
	public int getX() {
		if (influenceAreaDataControl.hasInfluenceArea()) {
			int left = (int) (imageElementReference.getX() - imageElementReference
					.getWidth()
					* imageElementReference.getScale() / 2);
			return left + influenceAreaDataControl.getX()
					+ influenceAreaDataControl.getWidth() / 2;
		} else
	...
	public int getY() {
		if (influenceAreaDataControl.hasInfluenceArea()) {
			int upper = (int) (imageElementReference.getY() - imageElementReference
					.getHeight()
					* imageElementReference.getScale());
			return upper + influenceAreaDataControl.getY()
					+ influenceAreaDataControl.getHeight();
		} else
