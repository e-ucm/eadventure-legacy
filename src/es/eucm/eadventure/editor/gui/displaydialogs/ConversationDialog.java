...
public class ConversationDialog extends JPositionedDialog implements ClockListener {
    ...
    /**
     * Array of integer, containing the current frame of the animations of each
     * character.
     */
    ...
    /**
     * Skips one line of the dialog. Changes to the next line if there are more,
     * or to the next conversation node if the current one has ended.
     */
    ...
    /**
     * Panel used to display the images. If the dialog is used for display, the
     * image usually presents some flickering.
     */
    ...
    /**
     * Listener for the mouse. Processes the mouse clicks and movements (for
     * option selection).
     */
