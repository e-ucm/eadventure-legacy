    ...
    public ChangeIntegerValueTool( Object data, Integer newValue, String getMethodName, String setMethodName, boolean updateTree, boolean updatePanel ) {
        ...
        try {
            ...
            if( get.getReturnType( ) != Integer.class ) {
                ...
                ReportDialog.GenerateErrorReport( new Exception( "Get method must return Integer value" ), false, TC.get( "Error.Title" ) );
            }
        }
