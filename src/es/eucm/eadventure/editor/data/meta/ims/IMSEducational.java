...
public class IMSEducational {
    ...
    public IMSEducational( ) {
        ...
        this.interactivityType = new Vocabulary( Vocabulary.IMS_ED_INTERACTIVITY_TYPE_5_1 );
    ...
    public void addLearningResourceType( int index ) {
        ...
        this.learningResourceType.add( new Vocabulary( Vocabulary.IMS_ED_LEARNING_RESOURCE_TYPE_5_2, index ) );
    }
    ...
    public void setContext( int index ) {
        ...
        this.context = new ArrayList<Vocabulary>( );
        this.context.add( new Vocabulary( Vocabulary.IMS_ED_CONTEXT_5_6, index ) );
    }
