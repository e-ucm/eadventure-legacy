...
public class Frame implements Cloneable, Timed {
	 ...
	 * 
	 * @param uri the uri/path of the frame resource
	 */
	 ...
	 * 
	 * @param time the time (duration) of the frame in milliseconds
	 */
	 ...
	 * 
	 * @param mirror If true, the image is vertically inverted
     ...
     * @param y The scale alogn the y-axis
