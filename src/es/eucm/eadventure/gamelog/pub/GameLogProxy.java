...
public class GameLogProxy implements _GameLogController{

    private _GameLogController glController;
    ...
    public GameLogProxy (){
        ...
        if (glConfig.getControllerClass( )!=null && 
            ...
            try {
                glController = (_GameLogController) Class.forName( glConfig.getControllerClass( ) ).getConstructor( GameLogConfig.class ).newInstance( glConfig );
            }
            catch( Exception e ) {
