...
public class ReportDialog extends JDialog {
    ...
    public ReportDialog( Frame owner, AssessmentEngine assessmentEngine, String adventureID ) {
        ...
        // Set the values
        super( owner, TextConstantsEngine.getText( "Report.Title" ), true );
        ...
        c.gridwidth = 2;
        currentDirectoryPanel.add( new JLabel( TextConstantsEngine.getText( "Report.SelectFolder" ) ), c );
        ...
        c.gridx = 1;
        c.weightx = 0;
        JButton btnExamine = new JButton( TextConstantsEngine.getText( "Report.BtnExamine" ) );
        ...
        xmlReportPanel.setBorder( new TitledBorder( new EtchedBorder( EtchedBorder.LOWERED ), TextConstantsEngine.getText( "Report.XMLReport" ), TitledBorder.LEFT, TitledBorder.TOP ) );
        ...
        chkXMLReport = new JCheckBox( TextConstantsEngine.getText( "Report.GenerateXML" ), false );
        ...
        xmlReportInfo.setText( TextConstantsEngine.getText( "Report.TextXMLReport" ) );
        ...
        htmlReportPanel.setBorder( new TitledBorder( new EtchedBorder( EtchedBorder.LOWERED ), TextConstantsEngine.getText( "Report.HTMLReport" ) , TitledBorder.LEFT, TitledBorder.TOP ) );
        ...
        c.fill = GridBagConstraints.NONE;
        c.anchor = GridBagConstraints.LINE_START;
        chkHTMLReport = new JCheckBox( TextConstantsEngine.getText( "Report.GenerateHTML" ), false );
        ...
        c.gridx = 1;
        c.weightx = 0;
        lblImportanceFilter = new JLabel( TextConstantsEngine.getText( "Report.Importance" ) );
        lblImportanceFilter.setEnabled( chkHTMLReport.isSelected( ) );
        ...
        htmlReportInfo.setText( TextConstantsEngine.getText( "Report.TextHTMLReport" ) );
        ...
        JButton btnLoad = new JButton( TextConstantsEngine.getText( "Report.GenerateHTMLReport" ) );
        ...
        JButton btnCancel = new JButton( TextConstantsEngine.getText( "Report.Cancel" ) );
