...
public class FunctionalSpeak extends FunctionalAction {
	...
	public void start(FunctionalPlayer functionalPlayer) {
        ...
        if (resources.getAssetPath(Player.RESOURCE_TYPE_SPEAK_LEFT) != null && !resources.getAssetPath(Player.RESOURCE_TYPE_SPEAK_LEFT).equals(Game.ASSET_EMPTY_ANIMATION))
