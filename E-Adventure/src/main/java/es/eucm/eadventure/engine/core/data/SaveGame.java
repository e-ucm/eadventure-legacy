...
public class SaveGame implements Serializable {
     ...
     * 
     * @param playerX
     *            the player's horizontal position to save
     */
     ...
     * 
     * @param playerY
     *            the player's vertical position to save
     */
