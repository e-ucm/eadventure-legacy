...
public class SelectSimpleSoundTool  extends SelectResourceTool {
  ...
  //  private String oldName;
    ...
    public SelectSimpleSoundTool(HasSound sound) throws CloneNotSupportedException{
        super( createResources( sound ), createAssetInfoArray( ), 0 , 0 );
