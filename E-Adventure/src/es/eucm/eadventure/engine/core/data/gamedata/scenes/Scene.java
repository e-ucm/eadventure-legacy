...
public class Scene extends GeneralScene {
     ...
     * @param defaultX the horizontal coordinate
     * @param defaultY the vertical coordinate
     */
     ...
     * @param itemReference the item reference to add
     */
     ...
     * @param characterReference the character reference to add
     */
    ...
    /**
     * Returns whether this is a final scene
     * @return true if this is a final scene, false otherwise
     */
