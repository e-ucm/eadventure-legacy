...
public class MultimediaManager {
    ...
    /**
     * Returns an Image for imagePath. If the image file does not exists,
     * a FileNotFoundException is thrown.
     * @param imagePath
     * @param category image category for caching
    ...
    /**
     * Returns an Image for imagePath after mirroring it. If the image file does not exists,
     * a FileNotFoundException is thrown.
     * @param imagePath Image path
     * @param category Category for the image
     * @return an Image for imagePath.
     ...
     * @param category Image category to clear
     */
    ...
    /**
     * Returns a scaled image of the given image.
     * The new width is x times the old width.
     * The new height is y times the old height.
     ...
     * @param soundType the type of the sound to be created
     * @param soundPath the path to the sound to be created
     * @param loop whether or not the sound must be played in a loop
    ...
    /**
     * Returns an Id of the sound for the file in soundPath,
     * and sets whether it has to be played or not in a loop.
     * The sound's type is guessed from its soundPath's extension.
     * @param soundPath the path to the sound to be created
     * @param loop whether or not the sound must be played in a loop
     * @return an Id that represents the sound with the given configuration.
     */
     ...
     * and sets whether it has to be played or not in a loop.
     * @param soundType the type of the music to be created
     * @param soundPath the path to the music to be created
     * @param loop whether or not the music must be played in a loop
    ...
    /**
     * Returns an Id of the music for the file in musicPath,
     * and sets whether it has to be played or not in a loop.
     * The sound's type is guessed from its musicPath's extension.
     * @param soundPath the path to the music to be created
     * @param loop whether or not the music must be played in a loop
     * @return an Id that represents the music with the given configuration.
     */
     ...
     * @param soundId long The soundId
    ...
    /**
     * Update the status of all sounds cache and if they have finished, they
     ...
     * @param slidesPath base path to the animation frames
     * @param category Category of the animation
     * @return an Animation with frames animationPath_xy.jpg
     */
