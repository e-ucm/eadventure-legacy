...
public class SceneSubParser extends SubParser {
     ...
     */
    private static final int READING_EXIT = 4;

    /**
     * Constant for reading element reference tag
     */
    private static final int READING_ELEMENT_REFERENCE = 3;
    ...
    /**
     * Constant for subparsing barrier
     */
    ...
    public void startElement( String namespaceURI, String sName, String qName, Attributes attrs ) {
        ...
        if( subParsing == SUBPARSING_NONE ) {
            ...
            if( qName.equals( "scene" ) ) {
                ...
                scene.setInitialScene( initialScene );
            }
            ...
            // If it is an exit tag, create the new exit
                ...
                currentExit = new Exit( x, y, x + width, y + height );
            ...
            // If it is a object-ref, create the new element reference
            ...
            // If it is a character-ref, create the new element reference
            ...
            // If it is a post-effect tag, create the new effect, the subparser and switch the state
                ...
                subParser = new ActiveAreaSubParser( gameData, scene );
            }
            
            // If it is a post-effect tag, create the new effect, the subparser and switch the state
            else if( qName.equals( "barrier" ) ) {
                subParsing = SUBPARSING_BARRIER;
                subParser = new BarrierSubParser( gameData, scene );
            }
    ...
    public void endElement( String namespaceURI, String sName, String qName ) {
        ...
        // If a condition is being subparsed
            ...
            if( qName.equals( "condition" ) ) {
                    ...
                    else if( reading == READING_NEXT_SCENE )
