...
public class AssessmentPanel extends JPanel implements DataControlsPanel {
	...
	private JPanel createFeedbackPanel(AssessmentProfileDataControl assRulesListDataControl) {
		...
		JButton expand = new JButton(TextConstants.getText("AssessementPanel.EditSMTPConfiguration"));
