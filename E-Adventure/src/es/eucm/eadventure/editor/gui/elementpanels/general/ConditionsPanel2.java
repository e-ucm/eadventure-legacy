...
public class ConditionsPanel2 extends JPanel {
	 ...
	 *            Controller for the conditions
	 */
	public ConditionsPanel2( ConditionsController conditionController ) {
		// Parent constructor
		super( );
		...
		public void mouseClicked( MouseEvent e ) {
			...
			if( e.getClickCount( ) == 2 ) {
				...
				if( selectedCondition >= 0 ) {
					...
					ConditionDialog conditionDialog = new ConditionDialog( new Integer( 0 ), TextConstants.getText( "Conditions.EditCondition" ), stateValue, flagValue, null, null );
