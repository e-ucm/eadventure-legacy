...
public class UseWithActionTreeNode extends TreeNode {
	 ...
	 */
	public UseWithActionTreeNode( TreeNode parent, ActionDataControl dataControl ) {
		super( parent );
	...
	protected int getNodeType( ) {
		return Controller.ACTION_USE_WITH;
	}
