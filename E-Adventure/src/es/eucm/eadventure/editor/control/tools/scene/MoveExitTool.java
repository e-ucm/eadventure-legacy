...
/**
 * That tool edit the changes in exit layer because of the fact of exits's
 * movements in ScenePanel table
 * 
 */
public class MoveExitTool extends Tool {
    ...
    public MoveExitTool( ExitsListDataControl dataControl2, JTable table2, boolean isMoveUp ) {
