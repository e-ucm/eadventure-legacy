...
import es.eucm.eadventure.adventureeditor.control.auxiliar.categoryfilters.ImageFileFilter;
import es.eucm.eadventure.adventureeditor.control.auxiliar.categoryfilters.VideoFileFilter;
import es.eucm.eadventure.adventureeditor.control.auxiliar.filefilters.JPGFileFilter;
import es.eucm.eadventure.adventureeditor.control.auxiliar.filefilters.JPGSlidesFileFilter;
import es.eucm.eadventure.adventureeditor.control.auxiliar.filefilters.MP3FileFilter;
import es.eucm.eadventure.adventureeditor.control.auxiliar.filefilters.PNGAnimationFileFilter;
import es.eucm.eadventure.adventureeditor.control.auxiliar.filefilters.PNGFileFilter;
...
import es.eucm.eadventure.adventureeditor.gui.assetchooser.AnimationChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.AssetChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.AudioChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.BackgroundChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.CursorChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.FormatedTextChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.IconChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.ImageChooser;
import es.eucm.eadventure.adventureeditor.gui.assetchooser.VideoChooser;
...
public class AssetsController {
    ...
    public static URL getResourceAsURLFromZip( String path ){
        try {
            return es.eucm.eadventure.adventureeditor.control.auxiliar.zipurl.ZipURL.createAssetURL( Controller.getInstance( ).getProjectFolder( ), path );
        } catch( MalformedURLException e ) {
            return null;
        }
    }
