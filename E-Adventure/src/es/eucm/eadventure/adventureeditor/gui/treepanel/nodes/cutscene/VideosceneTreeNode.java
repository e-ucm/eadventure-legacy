package es.eucm.eadventure.adventureeditor.gui.treepanel.nodes.cutscene;
...
import es.eucm.eadventure.adventureeditor.control.controllers.cutscene.CutsceneDataControl;
import es.eucm.eadventure.adventureeditor.control.controllers.general.NextSceneDataControl;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.cutscene.VideoscenePanel;
...
public class VideosceneTreeNode extends TreeNode {
	...
	public static void loadIcon( ) {
		icon = new ImageIcon( "img/icons/videoscene.png" );;
	}
	 ...
	 */
	public VideosceneTreeNode( TreeNode parent, CutsceneDataControl dataControl ) {
		super( parent );
	...
	protected int getNodeType( ) {
		return Controller.CUTSCENE_VIDEO;
	}
	...
	public JComponent getEditPanel( ) {
		return new VideoscenePanel( dataControl );
	}
