package es.eucm.eadventure.adventureeditor.gui.treepanel.nodes.book;
...
import es.eucm.eadventure.adventureeditor.gui.elementpanels.book.TextBookParagraphPanel;
import es.eucm.eadventure.adventureeditor.gui.treepanel.nodes.TreeNode;

public class TitleBookParagraphTreeNode extends TreeNode {
	...
	public static void loadIcon( ) {
		icon = new ImageIcon( "img/icons/titleBookParagraph.png" );;
	}
	 ...
	 */
	public TitleBookParagraphTreeNode( TreeNode parent, BookParagraphDataControl dataControl ) {
		super( parent );
	...
	protected int getNodeType( ) {
		return Controller.BOOK_TITLE_PARAGRAPH;
	}
