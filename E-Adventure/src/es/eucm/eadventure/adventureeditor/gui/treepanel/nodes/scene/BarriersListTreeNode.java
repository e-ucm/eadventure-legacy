...
import es.eucm.eadventure.adventureeditor.control.controllers.scene.BarrierDataControl;
import es.eucm.eadventure.adventureeditor.control.controllers.scene.BarriersListDataControl;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.scene.ActiveAreasListPanel;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.scene.BarriersListPanel;
