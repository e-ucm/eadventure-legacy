...
import es.eucm.eadventure.adventureeditor.gui.elementpanels.scene.ItemReferencePanel;
...
public class ItemReferenceTreeNode extends TreeNode {
	 ...
	 *            Parent node
	 * @param dataControl
	 *            Item reference to be contained
	 */
	public ItemReferenceTreeNode( TreeNode parent, ElementReferenceDataControl dataControl ) {
		super( parent );
	...
	protected int getNodeType( ) {
		return Controller.ITEM_REFERENCE;
	}
	...
	public JComponent getEditPanel( ) {
		return new ItemReferencePanel( dataControl );
	}
