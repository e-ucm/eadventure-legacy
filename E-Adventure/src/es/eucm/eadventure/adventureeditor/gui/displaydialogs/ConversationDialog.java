...
import es.eucm.eadventure.adventureeditor.gui.auxiliar.clock.Clock;
import es.eucm.eadventure.adventureeditor.gui.auxiliar.clock.ClockListener;
...
public class ConversationDialog extends JDialog implements ClockListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see es.eucm.eadventure.adventureeditor.gui.auxiliar.clock.ClockListener#update(long)
	 */
