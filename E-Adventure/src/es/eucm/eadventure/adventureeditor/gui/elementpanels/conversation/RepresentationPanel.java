package es.eucm.eadventure.adventureeditor.gui.elementpanels.conversation;
...
import es.eucm.eadventure.adventureeditor.control.config.ConversationConfigData;
import es.eucm.eadventure.adventureeditor.control.controllers.conversation.ConversationDataControl;
import es.eucm.eadventure.adventureeditor.control.controllers.conversation.GraphConversationDataControl;
import es.eucm.eadventure.adventureeditor.control.controllers.conversation.TreeConversationDataControl;
import es.eucm.eadventure.adventureeditor.data.chapterdata.conversation.node.ConversationNode;
...
import es.eucm.eadventure.adventureeditor.gui.displaydialogs.ConversationDialog;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.conversation.representation.GraphGraphicRepresentation;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.conversation.representation.GraphicRepresentation;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.conversation.representation.TreeGraphicRepresentation;
import es.eucm.eadventure.adventureeditor.gui.elementpanels.conversation.representation.graphicnode.GraphicNode;
