...
public class GameLogPoster {
    ...
    private static GameLogPoster instance;
    
    public static void setInstance (String serviceURL, String serviceKey){
        instance = new GameLogPoster(serviceURL, serviceKey);
    }
    
    public static GameLogPoster getInstance(){
        return instance;
    }
    ...
    public GameLogPoster(String serviceURL, String serviceKey){
    ...
    public static void main (String[]args){
        GameLogPoster poster = new GameLogPoster("", "");
